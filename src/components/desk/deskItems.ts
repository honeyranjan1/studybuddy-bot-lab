...
export const DESK_ITEMS: DeskItem[] = [
  { id: "notes", label: "Notes", caption: "subject + topic do, AI notes ready", to: "/notes", position: [-1.45, 0.78, 0.3] },
  ...
  { id: "interview", label: "Mock Interview", caption: "live rubric: clarity, depth, communication", to: "/mock-interview", position: [1.68, 0.8, 0.75], labelOffset: [0, 0.5, 0] },
  { id: "exams", label: "Exam Countdown", caption: "stay ahead of deadlines", to: "/exam-countdown", position: [-2.15, 0.78, 1.05] },
];
