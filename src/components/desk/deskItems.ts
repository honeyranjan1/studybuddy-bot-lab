...
export const DESK_ITEMS: DeskItem[] = [
  ...
  { id: "tutor", label: "AI Tutor", caption: "ask anything, anytime", to: "/chat", position: [0, 1.28, -0.55] },
  { id: "dsa", label: "DSA Practice", caption: "code, run, get feedback", to: "/dsa-practice", position: [1.5, 1.05, -0.35] },
